...
public final class StringUtils
{
    ...
    private final static Pattern phonenumber =
            Pattern.compile("^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$");
    ...
    /**
     * 从XML中解析整个元素值 如这样一个xml <?xml version=\1.0\?> <contact id="123" age="23" code="1">
     * <uri>sip:+8675558010098@10.0.2.15:10500</uri> 从中解析出来的结果为：<contact id="123" age="23" code="1">
     * 
     * @param src
     * @param element
     * @return
    ...
    {
        if (StringUtils.isEmpty(src) || StringUtils.isEmpty("<![CDATA[") || StringUtils.isEmpty("]]"))
        {
            return null;
        }
        ...
        String returnString = src.substring(begin + "<![CDATA[".length(), end).trim();
    ...
    public static String replaceQuanjiao(String hex)
    {
        // 需要替换为空串的字符
        String regKey =
            "(\\\\f[0-9] )|(\\\\f[0-9])|(\\\\cf[0-9][0-9] )|(\\\\cf[0-9][0-9])|(\\\\cf[0-9] )|"
    ...
    {
        if (resultCode.equals("200") || resultCode.equals("201") || resultCode.equals("202"))
        {
            return true;
        }
    ...
    public static String getMD5(String pwd)
    {
        ...
        catch (UnsupportedEncodingException e1)
        {
            ...
            System.out.println("MD5.getMD5() Exception: change String to UTF-8 code error." + e1.toString());
        }
    ...
    public static String getDistance(int distance)
    {
        ...
        return distance > 1000 ? String.format("%.2f千米", distance / 1000.0f) : String.format("%d米", distance);
    }
    ...
    public static String getDuration(int duration)
    {
        ...
        return hour > 0 ? String.format("%d小时%d分钟", hour, second) : String.format("%d分钟", second);
    }
