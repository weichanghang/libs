...
public final class CameraManager {
    ...
    //startPreview 崩溃发送广播
    public static final String INTENT_ACTION_PREVIEW="previewException";
     ...
     * 底部导航栏高度
     */
    private static int BOTTON_LAYOUT_HEIGHT = 61;
    ...
    public void closeDriver() {
        if (camera != null) {
            ...
            /*
             * mParameters.setFlashMode(Parameters.FLASH_MODE_OFF); camera.setParameters(mParameters);
             */
    ...
    public void startPreview() {
        if (camera != null && !previewing) {
            ...
            try {
                ...
                //发送错误广播到captureActivity
                Intent intent=new Intent();
                intent.setAction(INTENT_ACTION_PREVIEW);
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            int topOffset = (screenResolution.y - height - dp2px(context, BOTTON_LAYOUT_HEIGHT)) / 2;

            framingRect = new Rect(leftOffset + 30, topOffset-140, leftOffset + width - 30, topOffset + height-200);
