...
{
    private final byte[] yuvData; // 显示的数据
    private final int dataWidth;// 图片的宽度
    private final int dataHeight;// 图片的高度
    private final int left;// 离左边的距离
    private final int top;// 离上边的距离
    ...
    public Bitmap renderCroppedGreyscaleBitmap()
    {
        ...
        Bitmap bitmap = Bitmap.createBitmap(width, height,
                Bitmap.Config.ARGB_8888);// 图片的编码为8888
