...
public final class ViewfinderView extends View
{
    ...
    public ViewfinderView(Context context, AttributeSet attrs)
    {
        ...
        mDrawable = ((BitmapDrawable)(getResources().getDrawable(R.drawable.scan_ico_line_))).getBitmap();
    }
    ...
    public void onDraw(Canvas canvas)
    {
        ...
        else
        {
            ...
            // 画扫描框边上的角，总共8个部分
            paint.setColor(getResources().getColor(R.color.store_plus_blue));
...
//                    slideTop + MIDDLE_LINE_WIDTH / 2, paint);
            ...
            canvas.drawBitmap(mDrawable, null, lineRect, paint);
